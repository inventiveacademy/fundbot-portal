...
var applicants_create = require('./routes/applicants_create');
var applicants_update = require('./routes/applicants_update');
var applicants_details = require('./routes/applicants_details');
...
app.use('/applicants_create', applicants_create);
app.use('/applicants_update', applicants_update);
app.use('/applicants_details', applicants_details);
